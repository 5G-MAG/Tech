...
# CAMARA: Connectivity Insights Subcriptions API Family

## Description

The “Connectivity Insights Subscriptions” API enables application developers to receive continuous updates about network quality through event notifications. This allows developers to monitor network performance for their application users and receive alerts when network conditions change, helping them take informed decisions related to optimizing the application’s end user experience.
