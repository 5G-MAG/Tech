...
The QoS Profiles are used in the request body of other CAMARA APIs. This documentation only covers the specification of those for example applications.

## Example of a QoS Profile

An example of the QoS Profile, including status (provided in the response from the Network API platform):
